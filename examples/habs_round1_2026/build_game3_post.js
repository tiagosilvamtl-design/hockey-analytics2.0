...
const T = {
  en: {
    ...
    tldr_bullets: [
      ...
      'Through three games Dobes has a higher implied save percentage than Vasilevskiy (.892 vs. .880) on near-identical workloads (74 vs. 75 shots faced). Game 3\'s 29-vs-17 was the outlier; the cumulative read flips the pre-series chatter that Vasilevskiy was the more reliable option.',
  ...
  fr: {
    ...
    tldr_bullets: [
      ...
      'Sur les trois matchs, Dobes a un pourcentage d\'arrêts implicite supérieur à Vasilevskiy (,892 c. ,880) sur des charges quasi identiques (74 c. 75 tirs subis). Le M3 (29-17) est l\'exception; le cumul renverse l\'argument d\'avant-série voulant Vasilevskiy plus fiable.',
...
function claimsSection(t, lang) {
  ...
  const claimsEN = [
    ...
    { verdict: 'confirmed', claim: '"Dobes was at Vasilevskiy\'s level."', source: 'François Gagnon, RDS', data: 'Through 3 games Dobes\' implied SV% is .892 vs Vasilevskiy\'s .880. The chronique tracks the data.' },
  ...
  const claimsFR = [
    ...
    { verdict: 'confirmed', claim: '« Dobes était à la hauteur de Vasilevskiy. »', source: 'François Gagnon, RDS', data: 'Sur 3 matchs, le pourcentage d\'arrêts implicite de Dobes (,892) est légèrement supérieur à celui de Vasilevskiy (,880). La chronique colle aux chiffres.' },
