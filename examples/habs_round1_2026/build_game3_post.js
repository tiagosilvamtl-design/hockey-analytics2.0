...
const T = {
  en: {
    ...
    lineup_intro: 'The user instinct that "MTL kept the same lineup" was half right. The 18 skaters were unchanged, but two of MTL\'s four forward lines were reshuffled. The Radio-Canada game-day report flagged the change pre-puck-drop; we cross-checked it against the actual deployed lines from NHL.com\'s shift chart. Here is what changed.',
  ...
  fr: {
    ...
    lineup_intro: 'L\'intuition voulant que « le CH avait la même formation » est à moitié juste. Les 18 patineurs étaient les mêmes, mais deux des quatre trios offensifs ont été reconfigurés. Radio-Canada a signalé le changement avant la mise au jeu; les présences réelles tirées de LNH.com le confirment. Voici ce qui a bougé.',
